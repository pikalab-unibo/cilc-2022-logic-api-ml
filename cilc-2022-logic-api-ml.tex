...
\usepackage{cilc-2022-logic-api-ml}
\usepackage{lscape}
...
\conference{CILC 2022: 37th Italian Conference on Computational Logic, June 29 -- July 1, 2022, Bologna, Italy}
...
%
This is enabled by the \pl{multi\_layer\_perceptron/4} predicate, which requires the caller to provide the number of neurons to be instantiated for
%
\begin{inlinelist}
...
\begin{enumerate}
    ...
    \item testing that MLP against the \pl{ProcessedTestSet} -- obtained by applying \pl{Transformation} to the \pl{TestSet} --, thus computing the MLP actual \pl{Performance}
\end{enumerate}
%
...
\bibliography{cilc-2022-logic-api-ml}
